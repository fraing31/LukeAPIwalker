...
import ImpresionById from "./componentes/ImpresionById/ImpresionById";
      ...
      <Switch>
        <Route path="/formulario">
          <div>
            ...
            {selectBusqueda === "people" ? <Persona starWars={starWars} /> : ""}
        ...
        <div>
            <ImpresionById {...routeProps} 
             setInputBusqueda = {setInputBusqueda}
             setSelectBusqueda = {setSelectBusqueda}/>
